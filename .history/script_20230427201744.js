...
if (savedNama || savedEmail || savedPilihan || savedKeterangan) {
    savedData.innerHTML = `Nama: ${savedNama}<br>Email: ${savedEmail}<br>Pilihan: ${savedPilihan}<br>Keterangan: ${savedKeterangan}`;
}